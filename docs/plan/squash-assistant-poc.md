...
- ~~**Flag `force` resa-squash (après ADR-030)**~~ — tranché le 2026-09-11 ([ADR-031](../adr/ADR-031-reservation-toujours-forcee.md)) : `reserve_slot` est toujours appelé avec `force: true`, ni paramètre de règle ni dérivation depuis M.
